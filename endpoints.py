...
con_string = "mongodb+srv://khavya:khavyap@cluster0.k9cvgee.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('student')

user_collection=pymongo.collection.Collection(db,'sem')
